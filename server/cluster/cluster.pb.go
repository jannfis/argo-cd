...
func (*ClusterQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_9813acf5a23eaa9d, []int{0}
}
...
func (*ClusterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_9813acf5a23eaa9d, []int{1}
}
...
func (*ClusterCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_9813acf5a23eaa9d, []int{2}
}
...
type ClusterCreateFromKubeConfigRequest struct {
	...
	SystemAccountNamespace string   `protobuf:"bytes,5,opt,name=systemAccountNamespace,proto3" json:"systemAccountNamespace,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (*ClusterCreateFromKubeConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_9813acf5a23eaa9d, []int{3}
}
...
func (m *ClusterCreateFromKubeConfigRequest) GetSystemAccountNamespace() string {
	if m != nil {
		return m.SystemAccountNamespace
	}
	return ""
}
...
func (*ClusterUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_9813acf5a23eaa9d, []int{4}
}
...
func (m *ClusterCreateFromKubeConfigRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SystemAccountNamespace) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(len(m.SystemAccountNamespace)))
		i += copy(dAtA[i:], m.SystemAccountNamespace)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ClusterCreateFromKubeConfigRequest) Size() (n int) {
	...
	l = len(m.SystemAccountNamespace)
	if l > 0 {
		n += 1 + l + sovCluster(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ClusterCreateFromKubeConfigRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SystemAccountNamespace", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SystemAccountNamespace = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCluster(dAtA[iNdEx:])
...
func init() {
	proto.RegisterFile("server/cluster/cluster.proto", fileDescriptor_cluster_9813acf5a23eaa9d)
}

var fileDescriptor_cluster_9813acf5a23eaa9d = []byte{
	// 592 bytes of a gzipped FileDescriptorProto
	,
}
